...
import { MigrateAddressAutocomplete } from "@/components/migrate-job/MigrateAddressAutocomplete";
...
import type { MigrateJobFormState } from "@/components/migrate-job/useMigrateJobForm";

// Independent copy of components/jobs/JobFormFields.tsx, dedicated to the
...
type Props = MigrateJobFormState & {
  job?: Job | null;
...
export function MigrateJobFormFields({
  job,
          ...
          <Popover open={contactPickerOpen} onOpenChange={setContactPickerOpen}>
            ...
            >
              <Command filter={(value, search) => value.toLowerCase().includes(search.toLowerCase()) ? 1 : 0}>
                ...
                <CommandList>
                  <CommandEmpty>
                    {contactSearchTerm.trim() ? "No matching contacts." : "Type a name, email, or phone to search…"}
                  </CommandEmpty>
                  <CommandGroup>
