...
export const emptyJobForm: JobInsert = {
  name: "",
  email: "",
  phone: "",
  ghl_contact_id: null,
...
export function useJobForm({
  ...
  const [form, setForm] = useState<JobInsert>(emptyJobForm);
    ...
    if (open) {
      setForm(
        job
          ...
          : (() => {
              const serviceType =
                initialValues?.service_type ?? defaultServiceType ?? emptyJobForm.service_type;
              return {
                ...emptyJobForm,
                ghl_contact_id: defaultGhlContactId ?? null,
                service_type: serviceType,
                sale_date: serviceType === "installation" ? emptyJobForm.sale_date : null,
                ...initialValues,
              };
            })(),
      );
